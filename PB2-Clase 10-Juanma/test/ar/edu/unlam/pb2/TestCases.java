...
import ar.edu.unlam.pb2.Dominio.Billetera;
import ar.edu.unlam.pb2.Dominio.CBUInvalidoException;
import ar.edu.unlam.pb2.Dominio.CVUInvalidoException;
import ar.edu.unlam.pb2.Dominio.Comercio;
import ar.edu.unlam.pb2.Dominio.ComercioInexsistenteExcepcion;
import ar.edu.unlam.pb2.Dominio.Compra;
import ar.edu.unlam.pb2.Dominio.Consumidor;
import ar.edu.unlam.pb2.Dominio.CuentaBancaria;
import ar.edu.unlam.pb2.Dominio.CuentaVirtual;
import ar.edu.unlam.pb2.Dominio.CuitInvalidoException;
import ar.edu.unlam.pb2.Dominio.DNIinvalidoException;
import ar.edu.unlam.pb2.Dominio.ExcedeLimiteDeCompraException;
import ar.edu.unlam.pb2.Dominio.NoCoincideTitularException;
import ar.edu.unlam.pb2.Dominio.NumeroDeTarjetaInvalidoException;
import ar.edu.unlam.pb2.Dominio.Pagadora;
import ar.edu.unlam.pb2.Dominio.TarjetaDeCredito;
import ar.edu.unlam.pb2.Dominio.TarjetaDeDebito;
import ar.edu.unlam.pb2.Dominio.Transferible;
...
public class TestCases {
	...
	public void queSePuedaCrearUnaTarjetaDeCredito() throws NumeroDeTarjetaInvalidoException {
		...
		//En estos casos hay que CASTEAR, porque el metodo no va en la Interfaz
		//Es propio de la clase
		//Son trampas puestas a proposito
...
//	
	...
	public void queSePuedanAgregarDistintosMediosDePagoALaBilleteraDeUnConsumidor() throws NumeroDeTarjetaInvalidoException, CBUInvalidoException, CVUInvalidoException, NoCoincideTitularException, DNIinvalidoException{
		...
		mataGalan.agregarMedioDePago(27541231, new CuentaBancaria("01702046600000087800", "Naci�n", "Luis Gomez"));
		mataGalan.agregarMedioDePago(27541231, new CuentaVirtual("30000031000365215718060", "Mercado Pago", "Luis Gomez"));
		
		//Al ser un HASHMAP, compara con el equal de las clases que tiene
...
//	
	@Test
	public void queSePuedaPagarConUnaTarjetaDeCredito() throws NumeroDeTarjetaInvalidoException, CBUInvalidoException, CVUInvalidoException, ExcedeLimiteDeCompraException, NoCoincideTitularException, DNIinvalidoException, CuitInvalidoException, ComercioInexsistenteExcepcion{
		// Preparaci�n 
		Billetera mataGalan = new Billetera("Ank");
		mataGalan.agregarConsumidor(new Consumidor(27541231, "Luis Gomez"));
		...
		Boolean resultado = mataGalan.pagar(codigoQR, mataGalan.getConsumidor(27541231).getMedioPagador("48332562153254623"));
